                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="codigo" id="codigo" class="form-control"
                                            value="{{ old('codigo') }}" placeholder="Código único del producto" required>
                                    </div>
                                    @error('codigo')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="descripcion_corta" id="descripcion_corta" class="form-control" rows="2"
                                                    placeholder="Descripción breve del producto (máx. 255 caracteres)" maxlength="255" required>{{ old('descripcion_corta', '') }}</textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="precio_compra" id="precio_compra"
                                                    class="form-control" value="{{ old('precio_compra', 0) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="precio_venta" id="precio_venta"
                                                    class="form-control" value="{{ old('precio_venta', 0) }}"
                                                    placeholder="0.00" step="0.01" min="0" required>
                                            </div>
                                            @error('precio_venta')
                                                <small class="text-danger">{{ $message }}</small>
