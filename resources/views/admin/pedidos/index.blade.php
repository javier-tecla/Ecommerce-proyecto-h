                        ...
                        <tbody>
                            ...
                            @foreach ($pedidos as $pedido)
                                <tr>
                                    ...
                                    <td class="text-truncate" style="max-width: 120px;">{{ $pedido->usuario->name }} <br><small>{{ $pedido->usuario->email }} </small> </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="{{ url('/admin/pedido/' . $pedido->id) }}"
                                                class="btn btn-success btn-sm"><i class="bi bi-truck"></i> Tomar el pedido</a>
