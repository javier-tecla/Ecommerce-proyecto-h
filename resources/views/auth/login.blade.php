            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5">Acceso</button>
                    </form>
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">¿No tienes una cuenta? <a href="auth-register.html"
                                class="font-bold">Regístrate</a></p>
                        <p><a class="font-bold" href="auth-forgot-password.html">¿Has olvidado tu contraseña?</a></p>
                    </div>
                </div>
            </div>
