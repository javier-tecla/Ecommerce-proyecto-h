...
@section('content')
    <h1>Modificar categoría: {{ $categoria->nombre }} </h1>
    <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="slug" id="slug" class="form-control"
                                            value="{{ old('slug', $categoria->slug) }}" placeholder="Slug-de-la-categoria" readonly
                                            required>
                                    </div>
                                    @error('slug')
                                        <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="descripcion" id="descripcion" class="form-control" rows="4"
                                            placeholder="Descripción de la categoría (opcional)">{{ old('descripcion', $categoria->descripcion) }}</textarea>
                                    </div>
                                    @error('descripcion')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
